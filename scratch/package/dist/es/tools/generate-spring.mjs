...
function initGenerateSpringTool(server) {
    server.tool("generate-css-spring", description, args, async ({ bounce, duration }) => {
        const spring$1 = spring(bounce, duration);
        return {
            content: [
                {
                    type: "text",
                    text: spring$1.toString(),
                },
            ],
        };
    });
