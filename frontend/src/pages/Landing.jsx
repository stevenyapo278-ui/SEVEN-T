...
const PlanCard = ({ plan, isPopular = false }) => {
  ...
  const getFeaturesList = () => {
    ...
    if (features?.availability_hours) list.push('Heures de disponibilité')
    if (features?.voice_responses) list.push('Réponses vocales')
    if (features?.payment_module) list.push('Module paiement')
